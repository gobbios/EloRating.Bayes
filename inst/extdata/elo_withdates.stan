...
model {
  ...
  y ~ bernoulli(win_probs_presence_draws(EloStart, k, n_int, n_ind, winner_index, loser_index, presence, draws));
}
...
generated quantities {
  ...
  gq_winprobs = win_probs_presence_draws(EloStart, k, n_int, n_ind, winner_index, loser_index, presence, draws);
